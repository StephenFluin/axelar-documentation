...
<tab-item title="Mainnet">
 <pre><code>AXELARD_RELEASE=v0.33.1
TOFND_RELEASE=v0.10.1</code></pre>
...
<tabs>
<tab-item title="Mainnet">
 <pre><code>echo export CHAIN_ID=axelar-dojo-1 >> $HOME/.profile</code></pre>

</tab-item>
<tab-item title="Testnet">
 <pre><code>echo export CHAIN_ID=axelar-testnet-lisbon-3 >> $HOME/.profile</code></pre>
...
<tabs>
<tab-item title="Mainnet">
 <pre><code>axelard init $MONIKER --chain-id $CHAIN_ID
...
sed -i.bak 's/external_address = \"\"/external_address = \"'"$(curl -4 ifconfig.co)"':26656\"/g' $HOME/.axelar/config/config.toml</code></pre>
...
<tabs>
<tab-item title="Mainnet">
 <pre><code>axelard tendermint unsafe-reset-all
