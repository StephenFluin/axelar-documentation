...
<tab-item title="Mainnet">
 <pre><code># This is an example - check their docs and release page to opt for the right version
AVALANCHEGO=v1.9.3
</code></pre>
...
<tabs>
<tab-item title="Mainnet">
 <pre><code>echo export NETWORK_ID=mainnet >> $HOME/.profile</code></pre>

</tab-item>
<tab-item title="Testnet">
 <pre><code>echo export NETWORK_ID=fuji >> $HOME/.profile</code></pre>
